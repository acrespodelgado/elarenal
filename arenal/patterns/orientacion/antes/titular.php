    ...
    <div class="container p-sm-20">
        <div class="row">
            <div class="col col-12">
                ...
                <p>Te informamos sobre perfiles profesionales… para facilitar la inserción y reinserción laboral, la mejora del empleo y la movilidad laboral.</p>
                <p>Te acompañamos en el proceso de acreditación de competencias profesionales.</p>
            </div>
        </div>
    </div>
</div>