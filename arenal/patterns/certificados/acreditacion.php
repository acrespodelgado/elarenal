<div id="certificados-acreditacion">
    <div class="container p-xs-20">
        <div class="row">
            <div class="col col-12">
                ...
                <p>Si tienes una experiencia laboral de <strong>al menos 3 años</strong> o un mínimo de <strong>formación de 300 horas</strong>, puedes obtener el <strong>reconocimiento oficial de tus competencias profesionales</strong>. Y así aumentar tus posibilidades de encontrar empleo, mejorar tus condiciones laborales y seguir formándote.</p>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col col-12 primary-background"></div>
        </div>
    </div>
