	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content">
		...
		<div class="row">
			...
			<div class="col-md-12 content-area" id="primary">
				...
				<?php /* Deshabilitado 16/01/25 include get_stylesheet_directory() . '/patterns/oferta-educativa/oferta-educativa-slider.php'; */ ?>
                <?php /* Deshabilitado 16/01/25 include get_stylesheet_directory() . '/patterns/home/quienes-somos.php'; */ ?>
